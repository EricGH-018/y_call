...
def main():
    ...
    parser = argparse.ArgumentParser(description = "A Python package designed to make Y-haplogroup calls using large sets of SNPs and adressed to deal with ancient DNA issues.")
